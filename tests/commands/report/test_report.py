...
class TestReport:
    ...
    def test_initialize_model_excludes(self):
        model = report.initialize_model(
            "timespan=8-10;results=-2;excludes=events,slas;elements=TransactionName",
            "builtin:transactions")
        assert model == {'components':
                             {'all_requests': False,
                              'controller_points': False,
                              'events': False,
    ...
    def test_initialize_model_includes(self):
        model = report.initialize_model(
            "timespan=8-10;results=-2;includes=events,slas;elements=TransactionName",
            "builtin:transactions")
        assert model == {'components':
                             {'all_requests': False,
                              'controller_points': False,
