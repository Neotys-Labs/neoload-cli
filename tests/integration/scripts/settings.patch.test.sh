...
cmd='python neoload test-settings createorpatch "Test settings CLI patch"'
out=`eval $cmd`
...
# Patch name
cmd='python neoload test-settings --rename "Test settings CLI patch3" patch'
out=`eval $cmd`
assertJsonEquals '.name' '"Test settings CLI patch3"'
assertJsonEquals '.scenarioName' '"newScenario"'
assertJsonEquals '.description' '"my desc"'
assertJsonEquals '.lgZoneIds.zone' 3
assertJsonEquals '.lgZoneIds.zone2' 4
...
# Delete
cmd='python neoload test-settings delete "Test settings CLI patch3"'
out=`eval $cmd`
assertJsonEquals '.name' '"Test settings CLI patch3"'
