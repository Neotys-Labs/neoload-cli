...
class Configuration(object):
    ...
    def __init__(self, host="https://neoload-api.saas.neotys.com/v1",
            ...
            'NeoloadAuthorizer':
                {
                    ...
                    'in': 'header',
                    'key': 'accountToken',
                    'value': self.get_api_key_with_prefix('accountToken')
                },
        }
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://preprod-neoload-api.saas.neotys.com/v1",
