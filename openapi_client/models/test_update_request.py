...
class TestUpdateRequest(object):
    ...
    def __init__(self, name=None, description=None, quality_status=None, local_vars_configuration=None):  # noqa: E501
        """TestUpdateRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TestUpdateRequest):
            return False
