...
class SLAKPIDefinition(object):
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """SLAKPIDefinition - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SLAKPIDefinition):
            return False
