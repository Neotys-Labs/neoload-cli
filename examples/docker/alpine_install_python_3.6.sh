#!/bin/sh
# taken directly from https://github.com/docker-library/python/blob/7217b72192c93ca2033051d7191d5689932d3912/3.6/alpine3.12/Dockerfile
...
export PYTHON_PIP_VERSION=$PYTHON_PIP_VERSION
export PYTHON_GET_PIP_URL=$PYTHON_GET_PIP_URL
